...
class ProdutoCadastroComponent {
    constructor() {
    ...
    async init() {
        ...
        try {
            ...
            console.log("Componente de cadastro de produtos inicializado com sucesso");
        } catch (error) {
    ...
    async loadProdutos() {
        try {
            ...
            if (resultado.success) {
                ...
                this.renderizarHistoricoProdutos();
            } else {
    ...
    /**
     * Renderiza histórico de produtos
     */
    renderizarHistoricoProdutos() {
            ...
            <tr data-produto-id="${
                ...
                <td class="px-1 py-0.5">
                    <button 
                        ...
                        onclick="produtoModule.currentComponent.selecionarProduto(${
                            produto.id
                        })"
...
export default ProdutoCadastroComponent;